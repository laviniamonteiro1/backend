...
from blog.infra.models.bedroom_model import BedroomModel # <--- Ajuste seu caminho aqui!
from blog.infra.models.reservation_model import ReservationModel # <--- Ajuste seu caminho aqui! 
